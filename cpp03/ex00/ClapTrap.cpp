...
{
	std::cout << "\033[33mCalled default constructor\033[0m" << std::endl;
}

ClapTrap::ClapTrap(std::string name):name(name), hit_points(10), energy_points(10), attack_damage(0)
{
	std::cout << "\033[33mCalled constructor with name\033[0m" << std::endl;
}
ClapTrap::~ClapTrap()
{
	std::cout << "\033[31mCalled destructor\033[0m" << std::endl;
}
