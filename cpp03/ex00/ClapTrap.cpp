...
/*   Updated: 2026/04/15 21:18:18 by mkhavari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "\033[1;34mCalled constructor with name\033[0m" << std::endl;
}
ClapTrap::~ClapTrap()
{
...
{
	std::cout << "\033[1;33mCopy Construcotr was called\033[0m" << std::endl;
	// *this = other; // calling assignment operator has drawa
	// this->hit_points = 
}
...
{
	std::cout << "\033[1;31mcopy assignment constructor called\033[0m" << std::endl;
	if (this != &other)
	{
...
void ClapTrap::attack(const std::string& target)
{
    ...
    {
        std::cout << "\033[36mClapTrap " << this->name << " can't attack: no energy or hit_point to hit.\033[0m" << std::endl;
        return;
    }
...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    {
		//ClapTrap can’t do anything if it has no hit points or energy points left
        std::cout << "ClapTrap " << this->name << " can't take damage: it has not point ot hit" << std::endl;
        return;
    }
	...
	if (this->hit_points == 0)
		std::cout << "ClapTrap " << this->name << " has not enough point to hit!" << std::endl;
